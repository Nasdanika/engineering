 ...
 *
 */
public class EngineeringYamlSupplier extends EngineeringYamlLoadingExecutionParticipant implements Supplier<EObject> {

	private URI uri;
	
	public EngineeringYamlSupplier(URI uri, Context context) {
		super(context);
		this.uri = uri;
	}
