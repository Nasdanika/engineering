 ...
 * @generated
 */
public class JourneySwitch<T1> extends Switch<T1> {
	/**
	 ...
	 * @generated
	 */
	protected static JourneyPackage modelPackage;
	 ...
	 * @generated
	 */
	public JourneySwitch() {
		if (modelPackage == null) {
			modelPackage = JourneyPackage.eINSTANCE;
		}
	}
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JourneyPackage.ACTIVITY: {
				...
				if (result == null) result = caseFlow_Activity(activity);
			...
			case JourneyPackage.JOURNEY: {
				...
				T1 result = caseJourney(journey);
				if (result == null) result = caseFlow(journey);
				if (result == null) result = caseFlow_Activity(journey);
				if (result == null) result = caseFlowElement(journey);
				if (result == null) result = caseParticipantResponsibility(journey);
				if (result == null) result = casePackageElement(journey);
				if (result == null) result = caseNamedElement(journey);
				if (result == null) result = caseModelElement(journey);
				if (result == null) result = caseMarked(journey);
				if (result == null) result = caseAdaptable(journey);
				if (result == null) result = caseIMarked(journey);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T1 caseJourney(Journey object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public <T extends org.nasdanika.flow.Activity<T>> T1 caseFlow_Activity(org.nasdanika.flow.Activity<T> object) {
		return null;
	}
