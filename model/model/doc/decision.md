Decision is an [issue](Issue.html), which is also an [aim](Aim.html), i.e. [endeavors](Endeavor.html), such as issues, and other aims such as other decisions may be [aligned](Alignable.html) to it.
