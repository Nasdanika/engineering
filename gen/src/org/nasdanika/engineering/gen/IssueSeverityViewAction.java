...
public class IssueSeverityViewAction extends NamedElementViewAction<IssueSeverity> {
		
	public IssueSeverityViewAction(IssueSeverity value, EngineeringViewActionAdapterFactory factory) {
		super(value, factory);
	}
