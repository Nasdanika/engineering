[Objective](${doc-uri}Objective) is something that should be achieved as part of [endeavor](${doc-uri}Endeavor.html) such as an [increment](${doc-uri}Increment.html) or a [release](${doc-uri}Release.html).
