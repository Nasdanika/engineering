...
public class PrincipleViewAction extends AimViewAction<Principle> {
	...
	protected Collection<Action> featureActions(EStructuralFeature feature) {
		if (feature == EngineeringPackage.Literals.PRINCIPLE__CHILDREN) {
			...
			ModelElementFeatureViewAction<Principle, EStructuralFeature, ModelElementViewActionImpl<Principle>> childrenSection = createFeatureViewAction(feature, this::generateChildrenList);
